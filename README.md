...
* Igus ReBeL 6-DOF Robot: Ultra lightweight (8.2kg) plastic design, integrated control base, lubrication-free joints that enable clean, flexible and automated food service. 6DoFs allows the robot to mimic human actions and handle delicate tasks (e.g. pouring drinks, plating food)
